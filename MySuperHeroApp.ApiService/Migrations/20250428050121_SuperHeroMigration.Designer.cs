...
namespace MySuperHeroApp.ApiService.Migrations
{
    ...
    [Migration("20250428050121_SuperHeroMigration")]
                    ...
                    b.OwnsOne("MySuperHeroApp.ApiService.Model.Appearance", "Appearance", b1 =>
                        {
                            ...
                            b1.OwnsMany("MySuperHeroApp.ApiService.Model.Height", "Height", b2 =>
                                {
                                    b2.Property<int>("Id")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("int");
                                    ...
                                    b2.Property<string>("AppearanceSuperHeroId")
                                        .IsRequired()
                                        .HasColumnType("nvarchar(50)");
                                    ...
                                    b2.HasIndex("AppearanceSuperHeroId");

                                    b2.ToTable("Heights", (string)null);

                                    b2.HasAnnotation("Relational:JsonPropertyName", "height");

                                    b2.WithOwner()
                                        .HasForeignKey("AppearanceSuperHeroId");
                                });

                            b1.OwnsMany("MySuperHeroApp.ApiService.Model.Weight", "Weight", b2 =>
                                {
                                    b2.Property<int>("Id")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("int");
                                    ...
                                    b2.ToTable("Weights", (string)null);

                                    b2.HasAnnotation("Relational:JsonPropertyName", "weight");
                    ...
                    b.OwnsOne("MySuperHeroApp.ApiService.Model.Biography", "Biography", b1 =>
                        {
                            ...
                            b1.OwnsMany("MySuperHeroApp.ApiService.Model.Alias", "Aliases", b2 =>
                                {
                                    b2.Property<int>("Id")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("int");
                                    ...
                                    b2.Property<string>("BiographySuperHeroId")
                                        .IsRequired()
                                        .HasColumnType("nvarchar(50)");
                                    ...
                                    b2.HasIndex("BiographySuperHeroId");

                                    b2.ToTable("Aliases", (string)null);

                                    b2.HasAnnotation("Relational:JsonPropertyName", "aliases");

                                    b2.WithOwner()
                                        .HasForeignKey("BiographySuperHeroId");
                                });

                            b1.Navigation("Aliases");
                        });
